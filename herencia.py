...
class Profesor(Persona):
    ...
    def mostrarProfesor(self):
        ...
        print("\tTeléfono: ", self.getTeléfono())
...
def main():
    ...
    profesor.setTutorias(["Sistemas: lunes y sábados 8AM", "Matemáticas: jueves y viernes 6PM"])
    profesor.setTeléfono(3145648724)
